...
const translations = {
  ru: {
    ...
    "teachers.card2Bio": "Здесь можно указать профессиональный путь преподавателя, участие в методической работе, результаты курсантов и основные формы учебной деятельности.",
  ...
  kk: {
    ...
    "teachers.card2Bio": "Мұнда оқытушының кәсіби жолын, әдістемелік жұмысқа қатысуын, курсанттардың нәтижелерін және оқу қызметінің негізгі түрлерін көрсетуге болады.",
...
const contentOverrides = {
  ru: {
    ...
    "hero.title": "Цикл гуманитарных и общеобразовательных дисциплин",
    "hero.text1": "Цикл гуманитарных и общеобразовательных дисциплин является важным учебно-методическим подразделением Военного колледжа Министерства обороны Республики Казахстан. Его деятельность направлена на формирование у курсантов языковой, гуманитарной, гражданской и профессиональной компетентности.",
    ...
    "hero.taskText": "Формирование языковой, гуманитарной, гражданской и профессиональной компетентности у курсантов",
    ...
    "history.item1Text": "В сентябре 1996 года в Кадетском корпусе был образован цикл общеобразовательных дисциплин, который стал основой гуманитарной и языковой подготовки курсантов.",
    ...
    "history.item4Title": "Гуманитарная подготовка курсантов на современном этапе",
    "history.item4Text": "Сегодня цикл гуманитарных и общеобразовательных дисциплин продолжает развиваться, обеспечивая гуманитарную, языковую и общеобразовательную подготовку курсантов, формируя культуру речи, патриотизм и профессиональную компетентность.",
    ...
    "disciplines.text2": "Дисциплины цикла направлены на развитие общей культуры курсантов, формирование грамотной устной и письменной речи, расширение кругозора, развитие критического мышления и подготовку к профессиональному общению в военной среде.",
    ...
    "traditions.card1Text": "Преподаватели М.К. Космагамбетова и Н.М. Пилипенко внедряли в учебный процесс элементы педагогики сотрудничества, направленные на активное участие курсантов в обучении.",
    "traditions.card2Title": "Курсант как активный участник обучения",
    "traditions.card2Text": "Такой подход превращал курсанта из пассивного слушателя в активного участника учебного процесса, а преподавателя — в организатора совместной познавательной деятельности.",
    "traditions.card3Title": "Память и преемственность",
    "traditions.card3Text": "Память о преподавателях, внёсших вклад в становление цикла, бережно сохраняется в истории учебного заведения. Их труд и профессионализм остаются примером для нынешнего поколения преподавателей и курсантов.",
    ...
    "activity.card1Title": "Учебная работа",
    "activity.card1Text": "Преподаватели цикла проводят занятия по гуманитарным и языковым дисциплинам, используют современные методы обучения, интерактивные формы работы, практические задания, обсуждения, презентации и индивидуальную работу с курсантами.",
    "activity.card2Title": "Методическая работа",
    ...
    "activity.card4Text": "Через гуманитарные дисциплины курсанты знакомятся с историей государства, воинскими традициями, примерами мужества, дисциплины и служения Отечеству. Это способствует формированию ценностных ориентиров будущего военнослужащего.",
    "achievements.eyebrow": "Материальная база и достижения",
    "achievements.title": "Развитие условий обучения и достижения курсантов",
    ...
    "achievements.card2Text": "Это способствует повышению качества занятий, развитию познавательной активности курсантов и их успешному участию в олимпиадах, конкурсах и предметных мероприятиях различного уровня.",
    "achievements.card3Tag": "Достижения",
    "achievements.card3Title": "Олимпиады, конкурсы и конференции",
    "achievements.card3Text": "Курсанты, обучающиеся по дисциплинам цикла, принимают участие в районных, областных и республиканских предметных олимпиадах, интеллектуальных конкурсах, открытых занятиях, конференциях и воспитательных мероприятиях.",
    "today.eyebrow": "Цикл сегодня",
    "today.title": "Современная образовательная и воспитательная миссия",
    "today.text1": "Сегодня цикл гуманитарных и общеобразовательных дисциплин продолжает выполнять важную образовательную и воспитательную миссию. Его деятельность направлена на подготовку грамотных, ответственных, патриотически воспитанных и профессионально ориентированных курсантов.",
  ...
  kk: {
    ...
    "history.item4Title": "Қазіргі кезеңдегі курсанттардың гуманитарлық даярлығы",
    "history.item4Text": "Бүгінде гуманитарлық және жалпы білім беру пәндері циклі курсанттардың гуманитарлық, тілдік және жалпы білім беру даярлығын қамтамасыз етіп, сөйлеу мәдениетін, патриотизмді және кәсіби құзыреттілікті қалыптастыруды жалғастыруда.",
...
Object.assign(translations.ru, {
  ...
  "teachers.card6Bio": "Тажибекова Наргиз Кумарбековна преподаёт информатику, физику, графику и проектирование, а также дисциплины, направленные на развитие технического мышления, цифровой грамотности и инженерно-проектных навыков обучающихся. Имеет три высших образования: бакалавр Южно-Казахстанского государственного педагогического института имени Өзбекәлі Жәнібеков, окончила в 2013 году; Университет дружбы народов Казахстана, специальность «Бухгалтерский учет и отчетность», окончила в 2016 году; высшее образование по специальности «Дошкольное образование», окончила в 2017 году, точное название уточняется. Методическая проблема: использование современных информационных технологий и интерактивных методов обучения для развития логического мышления, технических навыков и познавательной активности обучающихся.",
  "teachers.card6Subjects": "Дисциплины: информатика, физика, графика и проектирование, цифровая грамотность, инженерно-проектные навыки",
  "teachers.card6Experience": "Общий педагогический стаж: 12 лет 5 месяцев, с 2014 года. Стаж работы в Военном колледже МО РК: с 01.09.2019 года по настоящее время.",
});
...
Object.assign(translations.kk, {
  ...
  "teachers.card6Name": "Тажибекова Наргиз Кумарбековна",
  "teachers.card6Bio": "Тажибекова Наргиз Кумарбековна информатика, физика, графика және жобалау пәндерін, сондай-ақ білім алушылардың техникалық ойлауын, цифрлық сауаттылығын және инженерлік-жобалау дағдыларын дамытуға бағытталған пәндерді жүргізеді. Үш жоғары білімі бар: 2013 жылы Өзбекәлі Жәнібеков атындағы Оңтүстік Қазақстан мемлекеттік педагогикалық институтын бакалавр дәрежесімен аяқтаған; 2016 жылы Қазақстан халықтар достығы университетін «Бухгалтерлік есеп және есептілік» мамандығы бойынша аяқтаған; 2017 жылы «Мектепке дейінгі білім беру» бағыты бойынша жоғары білім алған, нақты атауы кейін нақтыланады. Әдістемелік мәселесі: білім алушылардың логикалық ойлауын, техникалық дағдыларын және танымдық белсенділігін дамыту үшін заманауи ақпараттық технологиялар мен интерактивті оқыту әдістерін қолдану.",
  "teachers.card6Subjects": "Пәндер: информатика, физика, графика және жобалау, цифрлық сауаттылық, инженерлік-жобалау дағдылары",
  "teachers.card6Experience": "Жалпы педагогикалық өтілі: 12 жыл 5 ай, 2014 жылдан бастап. ҚР ҚМ Әскери колледжіндегі жұмыс өтілі: 01.09.2019 жылдан бастап қазіргі уақытқа дейін.",
});
...
Object.assign(translations.en, {
  ...
  "teachers.card6Bio": "Nargiz Kumarbekovna Tazhibekova teaches informatics, physics, graphics and design, as well as disciplines aimed at developing learners' technical thinking, digital literacy and engineering-design skills. She has three higher education degrees: bachelor's degree from the South Kazakhstan State Pedagogical Institute named after Ozbekali Zhanibekov, completed in 2013; University of Friendship of the Peoples of Kazakhstan, Accounting and Reporting, completed in 2016; higher education in Preschool Education, completed in 2017, with the full title to be clarified. Her methodological focus is the use of modern information technologies and interactive teaching methods to develop logical thinking, technical skills and learners' cognitive activity.",
  "teachers.card6Subjects": "Subjects: informatics, physics, graphics and design, digital literacy, engineering-design skills",
  "teachers.card6Experience": "Total teaching experience: 12 years 5 months, since 2014. Experience at the Military College of MoD RK: from 01.09.2019 to the present.",
});
